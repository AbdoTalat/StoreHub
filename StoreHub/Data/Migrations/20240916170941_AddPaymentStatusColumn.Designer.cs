...
namespace StoreHub.Data.Migrations
{
    ...
    [Migration("20240916170941_AddPaymentStatusColumn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreHub.Models.Entities.Address", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoreHub.Models.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StoreHub.Models.Entities.Order", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoreHub.Models.Entities.OrderItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StoreHub.Models.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StoreHub.Models.Entities.Order", b =>
                {
                    b.HasOne("StoreHub.Models.Entities.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StoreHub.Models.Entities.Payment", "Payment")
                        .WithMany()
            ...
            modelBuilder.Entity("StoreHub.Models.Entities.OrderItem", b =>
                {
                    b.HasOne("StoreHub.Models.Entities.Order", "Order")
                        .WithMany("OrderItems")
